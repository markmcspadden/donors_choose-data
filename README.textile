...
<code>
project = DonorsChoose::Data::Project.first<br/>
project.donations<br/>
school = DonorsChoose::Data::School.last<br/>
school.teachers<br/>
</code>
...
irb(main):001:0> require 'donors_choose'<br/>
irb(main):001:0> DonorsChoose::Data.connect(YAML.load(File.read('database.yml')))<br/>
irb(main):001:0> DonorsChoose::Data::Project.first<br/>
</code>
